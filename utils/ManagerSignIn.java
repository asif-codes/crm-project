...
import interfaces.IManagerSignInOperation;

import static javax.swing.JOptionPane.showMessageDialog;


public class ManagerSignIn implements IManagerSignInOperation {
        public boolean managerSignIn(String username, String password) {
            String userNameS = "User Name: " + username;
            String passwordS = "Password: " + password;
			String fileData = "";
            try{
                File file = new File(".\\data\\manager_data.txt");
