...
public class AddCustomer extends JFrame {
    ...
    public AddCustomer(String username, boolean isManagerCreation) {
                ...
                if (e.getSource() == b3) {
                    ...
                    if((!username.isEmpty() && !password.isEmpty() && !password1.isEmpty())){
                        if(password.equals(password1)){
                            ...
                            boolean customerCreated = customer.customerSignUp(username, password1, true);
                            if(customerCreated){
                                if (isManagerCreation) {
                                    new ManagerDashboard(username);
                                    setVisible(false);
