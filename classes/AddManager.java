...
public class AddManager extends JFrame {
    ...
    public AddManager(String username) {
                ...
                if (e.getSource() == b3) {
                    ...
                    if((!username.isEmpty() && !password.isEmpty() && !password1.isEmpty())){
                        if(password.equals(password1)){
                            ...
                            boolean managerCreated = manager.managerAdd(username, password1);
                            if(managerCreated){
                                new OwnerDashboard(username);
                                setVisible(false);
                            }
